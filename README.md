...
- **Đã nhập tự động** từ **4 đề VIP HSA 2025** (Ngôn ngữ + Tiếng Anh, kèm đáp án và lời giải):
  ...
  - Tổng ngân hàng hiện có: **423 câu** — Tiếng Việt 205, Tiếng Anh 206, Toán 6, Tư duy khoa học 6.
...
- Phần **Toán** và **Khoa học** chưa nhập vì chứa công thức/hình, chuyển sang text dễ lỗi.
